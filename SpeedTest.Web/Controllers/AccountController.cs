...
using SpeedTest.Sessions;
using SpeedTest.Web.Controllers.Results;
using SpeedTest.Web.Models;
using SpeedTest.Web.Models.Account;
...
{
    public class AccountController : SpeedTestControllerBase
    {
